...
import in.projecteka.datanotificationsubscription.common.model.KeyCloakError;
...
public class IdentityServiceClient {
    ...
    private Function<KeyCloakError, Mono<ClientError>> toClientError() {
        return keyCloakError -> error(unknownUnauthorizedError(keyCloakError.getErrorDescription()));
    }
}
