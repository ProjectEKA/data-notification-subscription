...
@AllArgsConstructor
public class HealthAccountOfflineTokenAuthenticator implements Authenticator {
    private final RSASSAVerifier tokenVerifier;
    private final CacheAdapter<String, String> blockListedTokens;
    private static final Logger logger = LoggerFactory.getLogger(HealthAccountOfflineTokenAuthenticator.class);
